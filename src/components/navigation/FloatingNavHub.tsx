    ...
    <>
            ...
            <div className="my-3 p-3 rounded-2xl bg-gradient-to-r from-teal-500/10 via-emerald-500/10 to-teal-500/5 dark:from-teal-950/50 dark:to-emerald-950/40 border border-teal-500/30 dark:border-teal-700/40 elev-xs">
              <div className="flex items-start justify-between gap-3">
                  ...
                  <div className="flex items-center justify-between gap-2">
                    ...
                    {onDismissReading && (
                      <button
                        ...
                        aria-label="Dispensar atalho de leitura"
                      >
                ...
                <button
                  ...
                  className="px-3 py-1.5 rounded-xl bg-teal-600 hover:bg-teal-700 text-white text-xs font-bold flex items-center gap-1 shrink-0 transition-colors cursor-pointer shadow-xs self-center"
                >
                  <span>Continuar</span>
      ...
      <div className="fixed bottom-3.5 left-1/2 -translate-x-1/2 z-40 w-[95%] max-w-lg flex flex-col items-center gap-2 pointer-events-none">
        ...
        {!isOpen && lastReadingSession && !isReading && (
          <div
            id="floating-continue-reading-hub"
            className="pointer-events-auto max-w-full inline-flex items-center rounded-full bg-slate-900/95 dark:bg-[#142038]/95 backdrop-blur-md border border-teal-500/40 text-white text-[11px] font-semibold elev-md shadow-lg transition-all pl-3 pr-1 py-1 gap-1"
          >
            <button
              type="button"
              id="btn-continue-reading-hub"
              onClick={handleResume}
            ...
            >
              ...
              <span className="truncate max-w-[170px] sm:max-w-[240px] text-slate-100">
                {lastReadingSession.compendiumTitle}
              </span>
              {lastReadingSession.sectionTitle && (
                <span className="hidden sm:inline-block truncate max-w-[130px] text-teal-200/80 font-normal">
                  · {lastReadingSession.sectionTitle}
                </span>
              )}
